#!/bin/bash
# MOD_CONTACTS_ACTIVATE - ECF_CONTACTS_BLD_ACTIVATE - Activation reelle du module Odoo
# "contacts" (Repertoire des contacts (clients, fournisseurs, partenaires)).
#
