#!/bin/bash
# ECFBCRDE - ECF_CRM_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "CRM_ACTIVE.ok"
