#!/bin/bash
# ECFBVTDE - ECF_VENTE_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "VENTE_ACTIVE.ok"
