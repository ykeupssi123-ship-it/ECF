#!/bin/bash
# MOD_JOBS_WEB_ACTIVATE - ECF_JOBS_WEB_BLD_ACTIVATE - Activation reelle du module Odoo
# "website_hr_recruitment" (Offres d emploi publiees en ligne).
#
...
odoo_module_activate "website_hr_recruitment"
