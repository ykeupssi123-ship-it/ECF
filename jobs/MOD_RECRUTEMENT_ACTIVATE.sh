#!/bin/bash
# MOD_RECRUTEMENT_ACTIVATE - ECF_RECRUTEMENT_BLD_ACTIVATE - Activation reelle du module Odoo
# "hr_recruitment" (Pipeline de recrutement).
#
...
odoo_module_activate "hr_recruitment"
