#!/bin/bash
# MOD_CONGES_ACTIVATE - ECF_CONGES_BLD_ACTIVATE - Activation reelle du module Odoo
# "hr_holidays" (Demandes de conges et absences).
#
...
odoo_module_activate "hr_holidays"
