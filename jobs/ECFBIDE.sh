#!/bin/bash
# ECFBIDE - ECF_SITE_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "SITE_ACTIVE.ok"
