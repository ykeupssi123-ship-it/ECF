#!/bin/bash
# MOD_SMSMKT_ACTIVATE - ECF_SMSMKT_BLD_ACTIVATE - Activation reelle du module Odoo
# "mass_mailing_sms" (Campagnes SMS marketing).
#
...
odoo_module_activate "mass_mailing_sms"
