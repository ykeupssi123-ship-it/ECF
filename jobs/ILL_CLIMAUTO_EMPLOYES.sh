#!/bin/bash
# ILL_CLIMAUTO_EMPLOYES - ECF_CLIMAUTO_RUN_EMPLOYES - Illustration : cree
...
echo "[ILL_CLIMAUTO_EMPLOYES] Creation de l'equipe CLIM AUTO..."
_odoo_shell_exec "
...
echo "[ILL_CLIMAUTO_EMPLOYES] Verification reelle en base..."
...
if [ "${NB:-0}" -lt 5 ]; then
  echo "[ILL_CLIMAUTO_EMPLOYES] ERREUR : seulement ${NB:-0}/5 employes trouves en base." >&2
  exit 1
fi

echo "[ILL_CLIMAUTO_EMPLOYES] OK (${NB} employes CLIM AUTO en base)."
exit 0
