#!/bin/bash
# MOD_ELEARNING_ACTIVATE - ECF_ELEARNING_BLD_ACTIVATE - Activation reelle du module Odoo
# "website_slides" (Plateforme de formation en ligne).
#
...
odoo_module_activate "website_slides"
