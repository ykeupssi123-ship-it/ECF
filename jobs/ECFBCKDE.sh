#!/bin/bash
# ECFBCKDE - ECF_CARTEMKT_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "CARTEMKT_ACTIVE.ok"
...
# en dependant (IN_COND=CARTEMKT_ACTIVE). Efface ici le marqueur ACTIVE
# pour que la condition reflete l'etat REEL courant, jamais un historique
# qui ne fait que s'accumuler.
rm -f "${STATE_DIR}/CARTEMKT_ACTIVE.ok"
