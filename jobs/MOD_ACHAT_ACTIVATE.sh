#!/bin/bash
# MOD_ACHAT_ACTIVATE - ECF_ACHAT_BLD_ACTIVATE - Activation reelle du module Odoo
# "purchase" (Commandes et appels d offres fournisseurs).
#
