#!/bin/bash
# MOD_VENTE_ACTIVATE - ECF_VENTE_BLD_ACTIVATE - Activation reelle du module Odoo
# "sale_management" (Devis, commandes et facturation client).
#
...
odoo_module_activate "sale_management"
