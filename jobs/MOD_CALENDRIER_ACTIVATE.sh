#!/bin/bash
# MOD_CALENDRIER_ACTIVATE - ECF_CALENDRIER_BLD_ACTIVATE - Activation reelle du module Odoo
# "calendar" (Agenda partage et rendez-vous).
#
