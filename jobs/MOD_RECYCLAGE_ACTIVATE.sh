#!/bin/bash
# MOD_RECYCLAGE_ACTIVATE - ECF_RECYCLAGE_BLD_ACTIVATE - Activation reelle du module Odoo
# "data_recycle" (Detection et archivage des donnees perimees).
#
...
odoo_module_activate "data_recycle"
