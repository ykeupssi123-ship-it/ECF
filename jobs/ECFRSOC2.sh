#!/bin/bash
# ECFRSOC2 - ECF_ILL2_RUN_SOCIETE - Illustration : cree la fiche
...
echo "[ILL2_SOCIETE] Creation/verification de la societe COUL..."
_odoo_shell_exec "
...
echo "[ILL2_SOCIETE] Verification reelle en base..."
...
if [ "$EXISTS" != "1" ]; then
  echo "[ILL2_SOCIETE] ERREUR : societe COUL introuvable en base apres creation." >&2
  exit 1
fi

echo "[ILL2_SOCIETE] OK."
exit 0
