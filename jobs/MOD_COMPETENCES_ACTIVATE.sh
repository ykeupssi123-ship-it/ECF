#!/bin/bash
# MOD_COMPETENCES_ACTIVATE - ECF_COMPETENCES_BLD_ACTIVATE - Activation reelle du module Odoo
# "hr_skills" (Competences et CV des employes).
#
...
odoo_module_activate "hr_skills"
