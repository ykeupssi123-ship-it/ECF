#!/bin/bash
# MOD_PRESENCE_ACTIVATE - ECF_PRESENCE_BLD_ACTIVATE - Activation reelle du module Odoo
# "hr_attendance" (Pointage des presences).
#
...
odoo_module_activate "hr_attendance"
