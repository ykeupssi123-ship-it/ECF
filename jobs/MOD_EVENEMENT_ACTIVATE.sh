#!/bin/bash
# MOD_EVENEMENT_ACTIVATE - ECF_EVENEMENT_BLD_ACTIVATE - Activation reelle du module Odoo
# "website_event" (Publication et billetterie d evenements).
#
...
odoo_module_activate "website_event"
