#!/bin/bash
# ECFBRCDE - ECF_RECRUTEMENT_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "RECRUTEMENT_ACTIVE.ok"
...
# en dependant (IN_COND=RECRUTEMENT_ACTIVE). Efface ici le marqueur ACTIVE
# pour que la condition reflete l'etat REEL courant, jamais un historique
# qui ne fait que s'accumuler.
rm -f "${STATE_DIR}/RECRUTEMENT_ACTIVE.ok"
