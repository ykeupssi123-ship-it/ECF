#!/bin/bash
# MOD_EMAILMKT_ACTIVATE - ECF_EMAILMKT_BLD_ACTIVATE - Activation reelle du module Odoo
# "mass_mailing" (Campagnes email marketing).
#
...
odoo_module_activate "mass_mailing"
