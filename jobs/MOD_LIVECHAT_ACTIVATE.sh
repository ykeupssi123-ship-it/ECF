#!/bin/bash
# MOD_LIVECHAT_ACTIVATE - ECF_LIVECHAT_BLD_ACTIVATE - Activation reelle du module Odoo
# "im_livechat" (Chat en direct sur le site web).
#
...
odoo_module_activate "im_livechat"
