#!/bin/bash
# MOD_MAINTENANCE_ACTIVATE - ECF_MAINTENANCE_BLD_ACTIVATE - Activation reelle du module Odoo
# "maintenance" (Suivi de maintenance des equipements).
#
...
odoo_module_activate "maintenance"
