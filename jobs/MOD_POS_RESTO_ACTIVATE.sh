#!/bin/bash
# MOD_POS_RESTO_ACTIVATE - ECF_POS_RESTO_BLD_ACTIVATE - Activation reelle du module Odoo
# "pos_restaurant" (Extensions caisse pour restauration).
#
...
odoo_module_activate "pos_restaurant"
