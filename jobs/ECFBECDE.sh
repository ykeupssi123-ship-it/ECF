#!/bin/bash
# ECFBECDE - ECF_ECOM_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "ECOM_ACTIVE.ok"
