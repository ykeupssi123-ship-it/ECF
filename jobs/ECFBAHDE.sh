#!/bin/bash
# ECFBAHDE - ECF_ACHAT_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "ACHAT_ACTIVE.ok"
