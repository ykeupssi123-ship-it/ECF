#!/bin/bash
# ECFBMDE - ECF_SMSMKT_BLD_DEACTIVATE - Desactivation reelle du module
...
# d'illustration Tier 2, voir docs/JOURNAL_TECHNIQUE.md) : "SMSMKT_ACTIVE.ok"
