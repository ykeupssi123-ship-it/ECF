...
# qui lit stdin par accident (ex: prompt GPG d'un nouveau depot dnf) ne
# doit jamais pouvoir voler un octet a un descripteur de fichier partage
# avec la boucle appelante.
